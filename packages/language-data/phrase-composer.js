...
var PhraseComposer = (() => {
  ...
  var COMPOSITIONS = {
    PHRASE_WATER_PLEASE: ["PARTICLE_HE", "THING_WAI", "STATE_PLEASE"],
    PHRASE_THANK_FOOD: ["PARTICLE_KIA", "STATE_ORA", "PARTICLE_MO", "PARTICLE_TE", "THING_KAI"],
    PHRASE_GOODBYE_LEAVE: ["PARTICLE_E", "ACTION_016", "PARTICLE_RA"],
    PHRASE_NOHO_MAI: ["ACTION_016", "PARTICLE_MAI"],
    PHRASE_WELCOME: ["ACTION_HAERE", "PARTICLE_MAI"],
    PHRASE_GOODBYE_STAY: ["ACTION_HAERE", "PARTICLE_RA"],
